...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pricecoinx-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pricecoinx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pricecoinx transaction") + "\n" +
              "  pricecoinx-tx [options] -create [commands]   " + _("Create hex-encoded pricecoinx transaction") + "\n" +
              "\n";
